        ...
        while(tt<=ejecucion[0].tme):
            ...
            if(msvcrt.kbhit()):
                ...
                # Agregar nuevo proceso
                    ...
                    # añadir a listos si hay menos de dos procesos en listos
                    if(len(listos) < 2):
...
def imprimirTablaProcesos():
    ...
    for i in range(0, len(terminados)):
        ...
        terminados[0].tretorno = terminados[0].tt
        if terminados[i]!=terminados[0]:
            terminados[i].espera = terminados[i-1].tfinalizacion
            terminados[i].tretorno = terminados[i].tfinalizacion - terminados[i].tllegada

        if terminados[i].error == 0:
            print(str(terminados[i].id) +"\t\t"+ str(terminados[i].tllegada) +"\t\t" + str(terminados[i].tme-terminados[i].tt + 1) +"\t\t" + str(terminados[i].tfinalizacion) 
    ...
    for i in range(0, len(ejecucion)):
        print(str(ejecucion[i].id) +"\t\t"+ str(ejecucion[i].tllegada) +"\t\t" + str(ejecucion[i].tme-ejecucion[i].tt + 1) +"\t\t" + str(ejecucion[i].tfinalizacion) 
    ...
    for i in range(0, len(bloqueados)):
        print(str(bloqueados[i].id) +"\t\t"+ str(bloqueados[i].tllegada) +"\t\t" + str(bloqueados[i].tme-bloqueados[i].tt + 1) +"\t\t" + str(bloqueados[i].tfinalizacion) 
    ...
    for i in range(0, len(listos)):
        print(str(listos[i].id) +"\t\t"+ str(listos[i].tllegada) +"\t\t" + str(listos[i].tme-listos[i].tt + 1) +"\t\t" + str(listos[i].tfinalizacion) 
